<?php
	...
	$onChampDataEntry = "INSERT INTO Overwatch(championName, championLore ,ability1Text, ability2Text, ability3Text, ability4Text, championImg ,buttonImg1, buttonImg2, buttonImg3, buttonImg4, passive1Text, passive1img, creatorAside) VALUES('$championName', '$championLore' ,'$ability1Text', '$ability2Text', '$ability3Text', '$ability4Text', '$championImage', '$ability1img', '$ability2img', '$ability3img', '$ability4img', '$passive1Text', '$passive1img', '$creatorAside')";

	$champCon->query($onChampDataEntry);

	

	if($result = $champCon->query("SELECT * FROM Overwatch")){
...
<html>
	<body>
		<h2>
			...
			<form method="get" action="http://championcreatrix.com/league/overwatch_display.php" name="creationConfirm">
