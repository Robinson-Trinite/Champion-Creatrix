<?php
	...
	if($result = $champCon->query("SELECT * FROM Overwatch where urlLocationNumber = $TESTING_GET")){
...
<html>
		<head>
			<title>Champion Creatrix: Create and Share Heroes</title>
			...
			<link rel="image_src" 
				type="image/jpeg" 
				href="http://championcreatrix.com/league/img/passiveOverwatch.jpg" />


			<meta property="og:image" content="http://championcreatrix.com/league/img/passiveOverwatch.jpg"/>
			<meta property="og:image:secure_url" content="http://championcreatrix.com/league/img/passiveOverwatch.jpg" />
		</head>
		...
		<body>
			<style type="text/css">
				body{
					color:white;
					background: url(img/passiveOverwatch.jpg) no-repeat center center fixed;
			...
			<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
			  	 ...
			  	 <div class="navbar-header">
		      		...
		      		<ul class="nav navbar-nav navbar-right aboveFade">
		                    ...
		                    <li>
		                        <a class="aboveFade" href="https://www.facebook.com/Championcreatrix/?ref=aymt_homepage_panel">Champion Creatrix Facebook Group</a>
		                    </li>

							<li>
		                        <a class="aboveFade" href="http://championcreatrix.com/league/">Create League Champion</a>
		                    </li>


		                    <li>
		                        <a class="aboveFade" href="http://championcreatrix.com/overwatch/index.html">Create Overwatch Hero</a>
		                    </li>

		                    <li class="">
			                    <a  href="http://championcreatrix.com/league/DonationPage.html">Support Champion Creatrix</a>
			                </li>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
				...
				<div class="row">
					<div class="col-md-12 aboveFade">
						<button type="button" class="btn btn-warning"  id="templatePassive"><img src="" width="100px" height="100px" id="templatePassiveImg"><br>Movement Style</button>

						<button type="button" class="btn btn-primary"  id="templateAbility1"><img src="" width="100px" height="100px" id="skill1Img"><br>gun left/right click</button>
						<button type="button" class="btn btn-primary" id="templateAbility2"><img src="" width="100px" height="100px" id="skill2Img"><br>Shift</button>
						<button type="button" class="btn btn-primary" id="templateAbility3"><img src="" width="100px" height="100px" id="skill3Img"><br>E Ability</button>
						<button type="button" class="btn btn-primary"  id="templateAbility4"><img src="" width="100px" height="100px" id="skill4Img"><br>Ultimate</button>
						<br>

				</div>
					

					<div class="col-md-10 col-md-offset-2 aboveFade">
